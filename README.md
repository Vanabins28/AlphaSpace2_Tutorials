...
The following tutorials were made for the [AlphaSpace2 platform](https://github.com/lenhsherr/AlphaSpace2). The tutorials below show how AlphaSpace2 and Beta Clusters can be used for a wide variety of applications in drug discovery, from binding site detection, comparison, and design. To use these tutorials, install AlphaSpace2 and run these jupyter notebooks. The necessary pdb and ligan structures are located in the folders corresponding to each tutorial.
